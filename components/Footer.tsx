    ...
    <footer className="p-2 bg-white fixed bottom-0">
        <div className="mx-auto">
            ...
            <div className="flex flex-1 flex-col items-center w-screen mt-2">
                <div className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <a href="https://www.mypost.money" className="hover:underline">MyPost™</a>. All rights Reserved.</div>
